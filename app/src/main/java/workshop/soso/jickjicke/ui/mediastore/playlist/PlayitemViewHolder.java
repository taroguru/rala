...
public class PlayitemViewHolder extends BaseViewHolder<PlayItem> {
    ...
    public PlayitemViewHolder(View itemView, Context context) {
        super(itemView);
        this.context = context;
        entireCardView  = (CardView)    itemView.findViewById(R.id.mediastore_arrayitem_playitem);
